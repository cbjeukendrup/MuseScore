...
static int readBoolFromXml(QXmlStreamReader& xml)
{
    ...
    if (xml.tokenType() == QXmlStreamReader::Characters) {
        if (xml.text().toString() == "true") {
            value = 1;
        } else if (xml.text().toString() == "false") {
            value = 0;
        } else {
