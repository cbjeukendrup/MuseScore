...
void NotationModule::resolveImports()
{
    ...
    if (ir) {
        ...
        ir->registerWidgetUri<ScorePropertiesDialog>(Uri("musescore://notation/properties"));
        ...
        ir->registerWidgetUri<Ms::StaffTextPropertiesDialog>(Uri("musescore://notation/stafftextproperties"));
