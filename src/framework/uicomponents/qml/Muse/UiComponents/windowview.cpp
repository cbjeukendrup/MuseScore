...
void WindowView::initView()
{
    ...
    QObject::connect(m_view, &QQuickView::closing, this, [this](QQuickCloseEvent* event){
        // Ugly hack because QQuickCloseEvent is defined in a private Qt header
        emit aboutToClose(reinterpret_cast<QObject*>(event));
    });
