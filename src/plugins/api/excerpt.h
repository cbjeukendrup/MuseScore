...
public:
    ...
    static qsizetype count(QQmlListProperty<T>* l) { return static_cast<Container*>(l->data)->size(); }
    static T* at(QQmlListProperty<T>* l, qsizetype i) { return excerptWrap<T>(static_cast<Container*>(l->data)->at(i)); }
};
